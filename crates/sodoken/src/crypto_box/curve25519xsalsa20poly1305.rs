    ...
    Seed: Into<BufReadSized<SEEDBYTES>> + 'static + Send,
{
    ...
    tokio_exec_blocking(move || {
        ...
        safe::sodium::crypto_box_curve25519xsalsa20poly1305_seed_keypair(
            &mut pub_key,
            &mut sec_key,
            &seed,
        )
    ...
    S: Into<BufWriteSized<SECRETKEYBYTES>> + 'static + Send,
{
    ...
    tokio_exec_blocking(move || {
        let mut pub_key = pub_key.write_lock_sized();
        let mut sec_key = sec_key.write_lock_sized();
        safe::sodium::crypto_box_curve25519xsalsa20poly1305_keypair(
            &mut pub_key,
            &mut sec_key,
        )
    })
    ...
    S: Into<BufReadSized<SECRETKEYBYTES>> + 'static + Send,
{
    ...
    tokio_exec_blocking(move || {
        ...
        let cipher = safe::sodium::crypto_box_curve25519xsalsa20poly1305_easy(
            &nonce,
            &message,
            &dest_pub_key,
            &src_sec_key,
    ...
    S: Into<BufReadSized<SECRETKEYBYTES>> + 'static + Send,
{
    ...
    tokio_exec_blocking(move || {
        ...
        safe::sodium::crypto_box_curve25519xsalsa20poly1305_open_easy(
            &nonce,
            &mut message,
            &cipher,
            &src_pub_key,
    ...
    P: Into<BufReadSized<PUBLICKEYBYTES>> + 'static + Send,
{
    ...
    tokio_exec_blocking(move || {
        ...
        let message = message.read_lock();
        let dest_pub_key = dest_pub_key.read_lock_sized();
        safe::sodium::crypto_box_curve25519xsalsa20poly1305_seal(
            &mut cipher,
            &message,
            &dest_pub_key,
        )
    ...
    S: Into<BufReadSized<SECRETKEYBYTES>> + 'static + Send,
{
    ...
    tokio_exec_blocking(move || {
        ...
        safe::sodium::crypto_box_curve25519xsalsa20poly1305_seal_open(
            &mut message,
            &cipher,
            &pub_key,
            &sec_key,
...
mod tests {
    ...
    async fn test_box() -> SodokenResult<()> {
        let nonce: BufReadSized<
            { crypto_box::curve25519xsalsa20poly1305::NONCEBYTES },
        > = BufReadSized::new_no_lock(
            [0; crypto_box::curve25519xsalsa20poly1305::NONCEBYTES],
        );
        ...
        crypto_box::curve25519xsalsa20poly1305::keypair(
            src_pub_.clone(),
            src_sec.clone(),
        )
        .await?;
        ...
        let cipher = crypto_box::curve25519xsalsa20poly1305::easy(
            nonce.clone(),
            msg.clone(),
            dest_pub_.clone(),
            src_sec.clone(),
    ...
    async fn test_box_seed() -> SodokenResult<()> {
        ...
        let src_seed: BufReadSized<
            { crypto_box::curve25519xsalsa20poly1305::SEEDBYTES },
        > = BufReadSized::new_no_lock(
            [0xdb; crypto_box::curve25519xsalsa20poly1305::SEEDBYTES],
        );
        let src_pub_: BufWriteSized<
            { crypto_box::curve25519xsalsa20poly1305::PUBLICKEYBYTES },
        > = BufWriteSized::new_no_lock();
        ...
        let dest_seed: BufReadSized<
            { crypto_box::curve25519xsalsa20poly1305::SEEDBYTES },
        > = BufReadSized::new_no_lock(
            [0xbd; crypto_box::curve25519xsalsa20poly1305::SEEDBYTES],
        );
        let dest_pub_: BufWriteSized<
            { crypto_box::curve25519xsalsa20poly1305::PUBLICKEYBYTES },
        > = BufWriteSized::new_no_lock();
        ...
        crypto_box::curve25519xsalsa20poly1305::seed_keypair(
            src_pub_.clone(),
            src_sec.clone(),
            src_seed.clone(),
        )
