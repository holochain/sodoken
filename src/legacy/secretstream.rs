...
//! # #[tokio::main]
//! # async fn main() {
//! use sodoken::legacy::secretstream::xchacha20poly1305::*;
//!
//! // both sides have a secret key
//! let key = sodoken::legacy::BufWriteSized::new_mem_locked().unwrap();
//! sodoken::legacy::random::bytes_buf(key.clone()).await.unwrap();
//! let key = key.to_read_sized();
//!
//! // -- encryption side -- //
//!
//! // initialize the stream
//! let header = sodoken::legacy::BufWriteSized::new_no_lock();
...
//! let cipher = sodoken::legacy::BufExtend::new_no_lock(0);
//! enc.push_final(
//!     b"test-message".to_vec(),
//!     <Option<sodoken::legacy::BufRead>>::None,
//!     cipher.clone(),
//! ).await.unwrap();
...
//! let msg = sodoken::legacy::BufExtend::new_no_lock(0);
//! let tag = dec.pull(
//!     cipher,
//!     <Option<sodoken::legacy::BufRead>>::None,
//!     msg.clone(),
